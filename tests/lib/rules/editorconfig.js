  ...
  const testConfigs = [
    {
      ...
      filename: join(__dirname, `../../configs/default/target.${ lang }`), // With .editorconfig
    },
    {
      name: "The plugin enforces fallback rules",
      filename: `/target.${ lang }`, // no .editorconfig
      fallback: true,
    },
    {
...
`,
    ...
    ruleTester.run(`${testConfig.name} - editorconfig/charset (${ lang })`, require("../../../lib/rules/charset"), {
      valid: [{
        ...commonValidTest,
    ...
    ruleTester.run(`${testConfig.name} - editorconfig/eol-last (${ lang })`, require("../../../lib/rules/eol-last"), {
      valid: [{
        ...commonValidTest,
...
`,
    ...
    ruleTester.run(`${testConfig.name} - editorconfig/indent (${ lang })`, require("../../../lib/rules/indent"), {
      valid: [
        {
          ...commonValidTest,
...
`,
    ...
    ruleTester.run(`${testConfig.name} - editorconfig/linebreak-style (${ lang })`, require("../../../lib/rules/linebreak-style"), {
      valid: [{
        ...commonValidTest,
    ...
    ruleTester.run(`${testConfig.name} - editorconfig/no-trailing-space (${ lang })`, require("../../../lib/rules/no-trailing-spaces"), {
      valid: [
        {
          ...commonValidTest,
