...
The backend ESLint rule is [`@stylistic/indent`](https://eslint.style/rules/indent).
...
As documented, `@stylistic/ts/indent` is unstable currently. Please read typescript-eslint/typescript-eslint#1824 before using this rule for TypeScript.
